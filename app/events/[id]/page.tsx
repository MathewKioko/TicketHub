...
import { Calendar, MapPin, DollarSign, Users, Ticket, ArrowLeft, CreditCard, Wallet, Loader2 } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen bg-mesh flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-kenyan-cream/60">Loading event...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-mesh flex items-center justify-center">
        <div className="text-center glass-dark rounded-2xl p-8">
          ...
          <Link href="/events">
            <Button className="bg-gradient-to-r from-kenyan-green to-kenyan-accent">Back to Events</Button>
          </Link>
        </div>
      </div>
    )
  ...
  return (
    <div className="min-h-screen bg-mesh">
      <div className="container mx-auto px-4 py-8">
        <Link 
          href="/events" 
          className="inline-flex items-center gap-2 text-kenyan-gold hover:text-kenyan-cream mb-8 font-semibold hover:scale-105 transition-all duration-300 group"
        >
            ...
            <Card variant="elevated" className="sticky top-8 animate-scale-in-bounce premium-border shine">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 gap-3">
                  ...
                  >
                    <Wallet className={`w-6 h-6 ${paymentMethod === 'PAYSTACK' ? 'text-green-600' : 'text-gray-600'}`} />
                    <span className={`text-sm font-semibold ${paymentMethod === 'PAYSTACK' ? 'text-green-700' : 'text-gray-700'}`}>
                      Paystack
                    </span>
                  </div>
                </div>
