      ...
      <div className="p-4">
        ...
        <div className="flex gap-3 mb-4">
          <div className="flex-1 relative">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-taupe/50 w-5 h-5" />
            <Input
              type="text"
          ...
          >
            ...
            Filters
            {hasActiveFilters && (
              <span className="ml-1 px-2 py-0.5 bg-gold text-onyx text-xs rounded-full font-bold">
        ...
        {isExpanded && (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 pt-4 border-t border-gold/10 animate-fade-in">
            {/* Date Range */}
            <div className="space-y-2">
              <label className="text-sm font-semibold text-ivory/70 flex items-center gap-2">
